...
export function SiteLayout({ children }: SiteLayoutProps) {
  return (
    <>
      ...
      <footer className="mx-auto mt-12 w-full max-w-6xl border-t border-stone-200/80 px-5 py-8 text-sm text-stone-600 dark:border-stone-800 dark:text-stone-400">
